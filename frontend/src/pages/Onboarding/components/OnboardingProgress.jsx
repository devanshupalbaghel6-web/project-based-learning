...
const steps = [
  { id: 1, name: 'Goal Setting', completed: true },
  { id: 2, name: 'Experience Level', completed: false },
  { id: 3, name: 'Interests', completed: false },
  { id: 4, name: 'Project Generation', completed: false },
];
            ...
            <div className="relative">
              ...
              {index < steps.length - 1 && (
                <div className={`absolute left-3 top-6 w-0.5 h-8 ${
                  step.completed ? 'bg-success-DEFAULT' : 'bg-secondary-200'
                }`}></div>
              )}
            </div>
